...
<!-- End Google Tag Manager -->
    ...
    <body id="body">
                ...
                <div class="blocks">
                  ...
                  <div class="block time_block">
                    ...
                    <div class="content">
                      ...
                      <p>10-00 до 21-00</p>
                      <div class="cards">
                        <img src="{THEME}/svg/card.svg?234" alt="">
                      </div>
                    </div>
                  </div>
                  <div class="block block_sections">
                    <span class="title">
                      Разделы
                    </span>
                    <div class="content">
                  ...
                  <div class="block">
                    ...
                    <div class="content">
                      <p>Киев, 04205</p>
                      <p>Оболонский проспект 21-б</p>
                      <a href="tel:{C_phone1}">{C_phone1}</a>
                      <div class="socials">
                        <a href="{C_fb}" target="_blank" class="fb" data-aos="fade-up" data-aos-duration="400" data-aos-delay="50" data-aos-offset="70"></a>
                        <a href="{C_inst}" class="inst" data-aos="fade-up" data-aos-duration="400" data-aos-delay="100" data-aos-offset="70"></a>
                        <a href="{C_yt}" target="_blank" class="yt" data-aos="fade-up" data-aos-duration="400" data-aos-delay="150" data-aos-offset="70"></a>
                        <a href="mailto:{C_mail}" class="mail" data-aos="fade-up" data-aos-duration="400" data-aos-delay="200" data-aos-offset="70"></a>
                      </div>
                    </div>
                  </div>
                </div>
                           ...
                           <div class="t-form__inputsbox">
                              <div class="t-input-group t-input-group_nm " data-input-lid="1496239431201">
                                 ...
                                 <div class="t-input-block">
                                    <input type="text " name="name" class="t-input js-tilda-rule " value="" data-tilda-rule="name" data-tilda-req="1" style="color:#000000; border:1px solid #000000;">
        ...
        <script type="text/template" class="wish-tpl">            
          <div id="rec5611528{tId}" class="prod r js-product" data-id="{tId}" data-prodid="{tId}" data-product-lid="{tId}" onclick="void(0)">
              <div class="image">
        ...
        <script type="text/template" class="product-tpl">            
            <div id="rec5611528{tId}" data-aos="fade-up" class="prod r js-product" data-prodid="{tId}" [if {M_[mobile]}==true]data-aos-offset="-75"[/if {M_[mobile]}==true] data-product-lid="{tId}" onclick="void(0)">
                {sale}
                <div class="add_to_wish"></div>
                <div class="image">
                    <div class="js-product-img"  style="background-image: url({tIzobrazhenie})"></div>
                    <span class="descr" data-id="{tId}"></span>
                    <!-- <span class="buy"></span> -->
