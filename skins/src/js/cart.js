...
function tcart__dict(t) {
    ...
    o = {
        EN: "Click to order\t",
        RU: "РћС„РѕСЂРјРёС‚СЊ Р·Р°РєР°Р·Р°С‚СЊ"
    },
    r[7] = o,
    o = {
        EN: "Subtotal with discount",
        RU: "Сумма СЃРѕ СЃРєРёРґРєРѕР№"
    },
    r[8] = o,
    o = {
        EN: "Promo code",
    ...
    o = {
        EN: "Minimal order",
        RU: "РњРёРЅРёРјР°Р»СЊРЅС‹Р№ Р·Р°РєР°Р·"
    },
    r[11] = o,
    o = {
        EN: "Minimal order quantity",
        RU: "РњРёРЅРёРјР°Р»СЊРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РІ Р·Р°РєР°Р·Рµ"
    },
    r[12] = o;
...
function tcart__loadLocalObj() {
    ...
    void 0 === (r = $(".t706").attr("data-project-currency-sep")) || "." != r && "," != r ? "$" == window.tcart.currency || "в‚¬" == window.tcart.currency || "USD" == window.tcart.currency || "EUR" == window.tcart.currency ? window.tcart.currency_sep = "." : window.tcart.currency_sep = "," : window.tcart.currency_sep = r,
